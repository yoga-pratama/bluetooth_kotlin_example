...
import com.dsn.bluetooth_connectivity_example.domain.chat.ConnectionResult
...
class AndroidBluetoothController(
    ...
    private val bluetoothStateReceiver = BluetoothStateReceiver { isConnected, bluetoothDevice ->
        if (bluetoothAdapter?.bondedDevices?.contains(bluetoothDevice) == true) {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                _errors.emit("Cannot connect to non-pair device")
            }
        }
    }
    ...
    companion object {
        //create random SERVICE_UUID
        const val SERVICE_UUID = "98cf1d75-69c4-4e22-aec4-622c1251d7ed"
